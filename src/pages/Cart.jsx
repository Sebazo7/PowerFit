...
export default function Cart() {
  ...
  return (
    <Container style={{ padding: "2rem 0" }}>
      <h2 className="bad-script-regular mb-4">Carrito</h2>
      {items.length === 0 ? (
        <p className="vend-sans-regular text-muted">Tu carrito está vacío.</p>
      ) : (
        <>
          <Table striped bordered hover className="vend-sans-regular">
            <thead>
              <tr>
                <th>Producto</th>
                <th>Precio</th>
